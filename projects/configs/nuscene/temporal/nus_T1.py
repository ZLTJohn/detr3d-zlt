...
resume_from = '/home/zhenglt/pure-detr3d/work_dirs/debug/epoch_2.pth'
...
model = dict(
    ...
    use_grid_mask=True,
    # debug_name='nus_T_ver0',
    # debug_dir='debug/nus_dataset_T/',
    img_backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
dataset_type = 'CustomNuScenesDataset_T_test_align'
