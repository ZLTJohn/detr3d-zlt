...
resume_from = '/home/zhenglt/pure-detr3d/work_dirs/depth_aware/epoch_2.pth'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=point_cloud_range, #transfusion setting
            pc_range=point_cloud_range,
            max_num=300,
...
data = dict(
    ...
    test=dict(
        ...
        box_type_3d='LiDAR',
        load_interval=5))
#### can not be evaluated properly in 'test', did not find cause
optimizer = dict(
    type='AdamW', 
    lr=2e-4,
    paramwise_cfg=dict(
