...
from .detr3d_transformer_temporal1_ver1_1 import PositionalEncoding
...
class Detr3DCrossAtten_T1v1_1_1(BaseModule):
    def __init__(self,
                 ...
                 init_cfg=None,
                 batch_first=False):
        super(Detr3DCrossAtten_T1v1_1_1, self).__init__(init_cfg)
        ...
        self.attention_weights_old = nn.Linear(embed_dims,
                                           num_cams*num_levels*num_points)
    ...
    def forward(self,
        ...
        attention_weights_old = self.attention_weights_old(query_old).view(
