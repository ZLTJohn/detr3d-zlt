...
class Detr3DTransformer_T(BaseModule):
    ...
    def __init__(self,
                 ...
                 decoder=None,
                 **kwargs):
        super(Detr3DTransformer_T, self).__init__(**kwargs)
    ...
    def init_weights(self):
        ...
        for m in self.modules():
            if isinstance(m, MultiScaleDeformableAttention) or isinstance(m, Detr3DCrossAtten_T):
                m.init_weight()
...
class Detr3DTransformerDecoder_T(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False, **kwargs):
        super(Detr3DTransformerDecoder_T, self).__init__(*args, **kwargs)
